 ...
 * @since 14/11/2020
 */
public class CommandWarpAllow implements CommandExecutor {
    private final SpigotPlugin plugin;
    private final AccessList accessList;

    public CommandWarpAllow(SpigotPlugin plugin, AccessList accessList) {
        this.plugin = plugin;
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length < 1) {
            sender.sendMessage(ChatColor.RED + "Must provide the nickname of the player to whitelist");
            return false;
        }
